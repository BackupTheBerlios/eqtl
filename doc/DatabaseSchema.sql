...
--
-- Table structure for table `BEARatChip`
--

DROP TABLE IF EXISTS `BEARatChip`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BEARatChip` (
  `probeset_id` char(10) NOT NULL,
  `seqname` char(5) DEFAULT NULL,
  `strand` char(1) DEFAULT NULL,
  `start` int(11) DEFAULT NULL,
  `stop` int(11) DEFAULT NULL,
  `total_probes` int(11) DEFAULT NULL,
  `gene_assignment` text,
  `first_representative_public_id` char(20) DEFAULT NULL,
  `first_symbol` text,
  `first_name` char(200) DEFAULT NULL,
  `first_location` char(5) DEFAULT NULL,
  `entrez_gene_ID` int(11) DEFAULT NULL,
  `mrna_assignments` char(200) DEFAULT NULL,
  `swissprot_ID` char(200) DEFAULT NULL,
  `swissprot_link` char(200) DEFAULT NULL,
  `unigene` text,
  `unigene_link` char(200) DEFAULT NULL,
  `GO_biological_process` text,
  `GO_cellular_component` text,
  `GO_molecular_function` text,
  `pathway` char(200) DEFAULT NULL,
  `protein_domains` text,
  `crosshyb_type` char(3) DEFAULT NULL,
  `category` char(50) DEFAULT NULL,
  `ProbeSequence` varchar(150) DEFAULT NULL,
  `hum_onth_ens` char(15) DEFAULT NULL,
  `gene_stable_id_rat` char(15) DEFAULT NULL,
  PRIMARY KEY (`probeset_id`),
  KEY `beaProbeChromosome` (`probeset_id`,`seqname`)
