                   ...
                   if($line != NULL)
                            {
                              ...
                              if($ids[2] = -1)
                                  {
                                   $edge = '{id:"'.$ids[0].'to'.$ids[1].'",target:"'.$ids[0].'",source:"'.$ids[1].'",directed: true,label:"'.$ids[1].' to '.$ids[0].'",weight:"'.$ids[4].'"}';
                                  }
                                  else {
                                        $edge = '{id:"'.$ids[1].'to'.$ids[0].'",target:"'.$ids[1].'",source:"'.$ids[0].'",directed: true,label:"'.$ids[0].' to '.$ids[1].'",weight:"'.$ids[4].'"}';
                                       }
