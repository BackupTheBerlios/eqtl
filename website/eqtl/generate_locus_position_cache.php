...
mysql_query("DROP TABLE IF EXISTS hajo_locus_to_position");
mysql_query("CREATE TABLE hajo_locus_to_position (
...
while ($row = mysql_fetch_assoc($result)) {
    ...
    echo " ".$pos."<br>\n";
    mysql_query("INSERT INTO hajo_locus_to_position SET locus_id='".$row["No"]."', positionBP='".$pos."' ");
}
?>
