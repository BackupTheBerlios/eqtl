...
<p>Name of exp.1 (speciesname) over the columns: <span id="species1"
  class="display_species"><?php echo $projects[0]." (".$species_names[0].")";?></span>;
Name of exp.2 (speciesname) over the rows: <span id="species2"
  class="display_species"><?php echo $projects[1]." (".$species_names[1].")";?></span>.</p>
<div style="display: none;">
<div id="exp1"><?php echo implode("+", explode(" ", $projects[0])) ?></div>
<div id="exp2"><?php echo implode("+", explode(" ", $projects[1])) ?></div>
</div>
