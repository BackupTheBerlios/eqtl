...
echo'<label for="'.$species_str.'">Species: </label> <select
...
echo'<p><label for="'.$species_str.'">Species: </label> <select
  name="'.$species_str.'" size="'.$num_species.'">';
...
$chrs = getChromosomsAndLengths($compara,$species2genome_db_ids[$species]);
